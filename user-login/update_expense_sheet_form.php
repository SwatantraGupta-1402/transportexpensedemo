...
//error_reporting(E_ALL);
 require_once('../includes/config.php');
    session_start();
     ...
     if(isset($_SESSION['user_name'])){
        if((time()-$_SESSION['last_time']) > 60*15){
            ...
            if(isset($_GET['ID'])){ 
             $ExpenseformID = $_GET['ID'];
             
             $sql = "SELECT SUM(day_wise_distance) as tot_distance FROM expense_sheet_form";
             $sql_result = mysqli_query($connection, $sql);
             $row = mysqli_fetch_assoc($sql_result);
            
            $sql_query_user = "SELECT esf.*,SUM(esf.diesel_in_liter) as tot,ur.user_id,ur.full_name,ur.vehicle_reg,ur.vehicle_type,(esf.total_expense - esf.total_expense_day_wise) as opening,(esf.total_distance / esf.total_diesel_leter) as diesel_avg FROM `expense_sheet_form` as esf 
    ...
    $sql_query_update = "UPDATE `expense_sheet_form` SET
      ...
      diesel_in_liter = '$intDieselLiter', vehicle_reg = '$strVehicleReg',
      vehicle_type = '$strVehicleType',geo_location = '$strGeoLocation',updated_by = '$updated_by',updated_date = '$updated_date' WHERE user_id = '$intUserId' and expense_form_id =".$_POST['expense_id'];
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" placeholder="Total Diesel in Litre" name="total_diesel_leter" id="total_diesel_leter" value="<?php echo $row_user['total_diesel_leter']; ?>" required="" style="border-radius: 5px;" readonly="readonly"> 
                                                        </div>
                                                    </div>
                                                    <!--<div class="form-group col-md-3">-->
